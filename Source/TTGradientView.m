...
- (NSNumber *)drawTriangle {
    return _drawTriangle ? _drawTriangle : @1;
}
...
- (void)drawRect:(CGRect)rect {
    ...
    // If we skip the triangle portion then we'll end up with a straight border along the bottom
    if ([[self drawTriangle] boolValue] == YES) {
